...
export default function PostCard({ name, username, content, time, avatar }: PostProps) {
  return (
    <div className="p-4 border-b border-custom hover:bg-white/2 transition-premium cursor-pointer group bg-card my-3 rounded-2xl shadow-lg">
      <div className="flex gap-3 ">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-1">
            <span className="font-bold text-white hover:underline decoration-1">
              {name}
            </span>
