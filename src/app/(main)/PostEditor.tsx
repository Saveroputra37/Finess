...
export default function PostEditor() {
  ...
  return (
    <div className="border-b border-custom p-4 bg-card transition-colors">
      <div className="flex gap-4">
        <div className="h-12 w-12 overflow-hidden rounded-full border border-custom bg-slate-900 flex-shrink-0">
          {user?.imageUrl ? (
        ...
        <div className="flex-1 space-y-3">
          ...
          <div className="flex items-center justify-between pt-3 border-t border-custom">
            <div className="flex gap-1 text-primary">
              <button type="button" className="p-2 hover:bg-primary/10 rounded-full transition-premium">
